...
namespace demiplane::db::interfaces {
    ...
    public:
        ...
        TransactionManager(TransactionManager&& other) noexcept : tables_(std::move(other.tables_)) {}
        ...
        void add_table(const std::string& tableName, std::shared_ptr<database::interfaces::DbInterface> dbConnection,
