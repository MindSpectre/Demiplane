...
std::chrono::milliseconds demiplane::math::random::RandomTimeGenerator::generate_milliseconds(
    const uint32_t target_ms, const int8_t deviation ) const {
...
std::chrono::year_month_day demiplane::math::random::RandomTimeGenerator::generate_date(
...
std::chrono::year_month_day demiplane::math::random::RandomTimeGenerator::generate_date_from_to_now(
...
std::chrono::year_month_day demiplane::math::random::RandomTimeGenerator::generate_date_to(
...
std::pair<std::chrono::year_month_day, std::chrono::year_month_day>
    demiplane::math::random::RandomTimeGenerator::generate_time_period(
        const std::chrono::year_month_day& from, const std::chrono::year_month_day& to) const {
...
inline uint32_t demiplane::math::random::NumberGenerator::generate_random_uint32(const uint32_t min, const uint32_t max) const {
