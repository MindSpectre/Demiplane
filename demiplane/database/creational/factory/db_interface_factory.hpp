...
namespace demiplane::database::creational {
    ...
    public:
        static std::unique_ptr<interfaces::DbInterface> create_pqxx_client(const ConnectParams& _params) {
        ...
        static std::unique_ptr<interfaces::DbInterface> create_basic_mock_database_prm(const ConnectParams& _params) {
            return std::make_unique<BasicMockDbClient>();
        }
        static std::unique_ptr<interfaces::DbInterface> create_basic_mock_database() {
            return std::make_unique<BasicMockDbClient>();
        }
        static std::unique_ptr<interfaces::DbInterface> create_silent_mock_database() {
