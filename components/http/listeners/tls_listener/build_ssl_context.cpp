...
namespace demiplane::http {
    ...
    boost::asio::ssl::context build_ssl_context(const TlsConfig& cfg, const std::string& advertised_alpn_wire) {
        ...
        // TODO(PR6): check SSL_CTX_set_cipher_list returns 1 and throw system_error on failure (a silent 0 falls back
        // to OpenSSL defaults, weakening the cipher floor this function guarantees).
