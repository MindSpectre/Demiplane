...
int main(int argc, char** argv) {
    ...
    auto strategy = [](PoolT& p) noexcept { return p.acquire_for(std::chrono::microseconds{2}); };
    return run_sync_bench_main<PoolT>(argc, argv, "RP_AcqFor_2us", FREE_REGION_SCENARIOS, make_pool, strategy);
}
