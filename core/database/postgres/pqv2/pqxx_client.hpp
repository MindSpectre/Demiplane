...
#include "pqxx_query_engine.hpp" // Contains PqxxQueryProcessor and QueryAndParams

namespace demiplane::database {

    class PqxxClient final : public DbInterface,
    ...
    private:
        ...
        void execute_query(const std::string& query_string, pqxx::params &&params) const;
        pqxx::result execute_query_with_result(const std::string& query_string, pqxx::params &&params) const;
